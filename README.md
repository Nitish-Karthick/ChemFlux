...
- Optional: Deploy the web app and share the link

## Troubleshooting
- 401/403 from API: ensure you created a Django user and are using correct credentials in Web/Desktop.
- CSV parsing errors: ensure the CSV is well-formed. Sample file is provided at `sample_equipment_data.csv`.
- CORS errors in Web: ensure backend is running and CORS settings allow your dev origin.
